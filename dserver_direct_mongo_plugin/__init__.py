...
import dserver.utils as server_utils
...
from dserver import ExtensionABC, ValidationError

from dserver import AuthenticationError
...
def query_datasets_by_user(username, query):
    ...
    See dserver.utils.search_datasets_by_user docstring.
